...
// ProviderInstance is the Schema for the providerinstances API
...
// ProviderInstanceList contains a list of ProviderInstance
type ProviderInstanceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ProviderInstance `json:"items"`
}

func init() {
	SchemeBuilder.Register(&ProviderInstance{}, &ProviderInstanceList{})
}
